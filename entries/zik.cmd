...
P
  ++
  1. (_onomatopoeia_) A clicking (or perhaps chirping) sound (Kangxi 喞: 喞聲也).
  ++
E
  ====
  - 【唧】 (zik1)
...
W
  ...
  - [[Page~13* 職(7)]]
    ...
    - _chik(7) yam(6)_
        [[zik1 jam6 職任]]
        in office, the duties of an office;
    - _(1)k(a/) chik(7)_
        [[gaa1 zik1 加職]]
        to confer a title;
    - _(1)p(i/) chik(7)_
...
V
  ...
  - ze6 (per 《廣韻》慈夜切 for "mat" and "borrow" senses and Kangxi 慈夜切 for "generous" sense)
  ==
F
  ==
  - (F1.78 藉) 賴也借也
