...
WP
  ==
  - Ch(i/) <span class="modern">= *[tɕiː]</span>
  - Tsz' <span class="modern">= *[tsɿː]</span>
  ==
MP
  ==
  - zi = [tsiː] ((preferred)), [tɕiː]
  ==
$$
...
W
  ...
  - [[Page~38|n81 (1)支]]
    ...
    - ~~to measure;~~
    - the 65th~radical [[U+2F40 ⽀ "branch"]];
    - _(1)p(a/)u (1)ch(i/)_
        [[baau1 zi1 包支]],
        responsible for;
...
W
  ...
  - [[Page~37|n80 (1)知]]
    ...
    - _(4)shui (1)ch(i/)_
        [[seoi4 zi1 誰知]],
        unexpected, who would have thought it?
    - _k(u/)(3) (1)ch(i/)_
        [[gu3 zi1 故知]],
        an old friend;
    - _(1)ch(i/) (1)t(i/)_
        [[zi1 di1 知啲]],
        I know a little;
    - _(1)ch(i/) (2)k(i/) (4)p(')ang (5)yau_
        [[zi1 gei2 pang4 jau5 知己朋友]],
        an intimate friend;
    - _(1)s(i/)n (1)ch(i/)_
        [[sin1 zi1 先知]],
        a prophet;
    ...
    - _(1)ch(i/) kok(8)_
        [[zi1 gok3 知覺]]
        to notice;
    - _(1)ch(i/) t(o\)(6) hai(6) (2)k(o\)m_
        [[zi1 dou6-3 hai6 gam2 知道係噉]],
        I know it is so;
    - _(4)(i/)m (1)ch(i/) sz'(6)_
        [[jim4 zi1 si6 鹽知事]]
        a salt commissioner;
    - _(1)ch(i/) (2)f(u/)_
        [[zi1 fu2 知府]],
    ...
    - _(1)ch(i/) tsuk(7)_
        [[zi1 zuk1 知足]]
        contented;
    - _pat(7) (1)ch(i/) (2)tai sai(3)_
        [[bat1 zi1 dai2 sai3 不知底細]]
...
W
  ...
  - [[Page~611 (1)胾]]
    --
    [[Reading variation. **See $胾zi3 for the canonical entry.**]]
    --
  ====
S
  ==
...
W
  ...
  - [[Page~39|n82 (2)止]]
    ...
    - to remain, to wait;
    - [[...]];
    - the 77th~radical [[U+2F4C ⽌ "stop"]] of characters mostly relating to rest;
    - [[...]];
    - _(1)ch(i/) (2)ch(i/)_
        [[zi1 zi2 知止]]^
...
F
  ...
  - (F2.35 訿 _(2)Ts(')z'_ (ci2)) 相詆也詩翕翕訿訿
  ==
W
  ====
...
P
  ++
  1. Alternative form of 訾 (for the "slander" sense). **See $訾zi2 for the canonical entry.**
  ++
$$
...
W
  ...
  - [[Page~39|n82 (2)黹]]
    ...
    - the 204th~radical [[U+2FCB ⿋ "embroidery"]], relating to embroidery;
    - _(1)cham (2)ch(i/)_
        [[zam1 zi2 針黹]],
...
W
  ...
  - [[Page~40|n83 至(3)]]
    ...
    - the 133d~radical [[U+2F84 ⾄ "arrive"]];
    - _ch(i/)(3) kik(9)_
        [[zi3 gik6 至極]]
        at the very extreme;
