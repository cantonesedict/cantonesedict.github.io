...
W
  ...
  - [[Page~22* 慴(8)]]
    --
    [[Alternative form of 懾, and reading variation. **See $懾sip3 for the canonical entry.**]] [[TODO]]
    --
  ====
C
  ==
...
W
  ...
  - [[Page~22* 摺(8)]]
    ...
    - _ch(i/)p(8) (4)m(a/)i_
        [[zip3 maai4 摺埋]],
        to shut up, as a book;
    - _ch(i/)p(8) (2)ch(i/)_
        [[zip3 zi2 摺紙]],
        to fold paper;
    - _ch(i/)p(8) kok(8)_
        [[zip3 gok3 摺角]]
        to turn down dog's ears;
    - _(2)shau ch(i/)p(8)_
        [[sau2 zip3 手摺]]
        a folded paper for memoranda;
    - _ch(i/)p(8) (1)kam (4)ngan_
        [[zip3 gam1 ngan4 摺金銀]],
        to fold paper to burn as clothes.
    ==
  ====
C
  ==
