...
C
  ==
  - Whilst _(4)ch(')(a/)m_ (caam4) is attested in Middle Chinese,
...
W
  ...
  - [[Page~554 (4)巉(4){𥕌=⿰石斬}]]
    ==
    - A high, inaccessible peak or cliff [[Kangxi 巉: 巉巖高也]];
    - a cloud-capt summit;
...
W
  ...
  - [[Page~554 (4)讒]]
    ...
    - to misrepresent, to gloss over, to calumniate,
      to asperse, to traduce, to detract [[Kangxi: 譖也, 崇飾惡言毀善害能也, 傷良曰讒]];
    - ~~servility;~~
