...
W
  ...
  - [[Page~65 (1)風]]
    ...
    - air-gusts, gale, wind [[Kangxi: 風以動萬物也 etc.]];
    - haste, fleetness;
    - manners, deportment, etiquette;
    - administration, policy;
    - fame, example, fashion [[Kangxi: 風俗]];
    - instruction, reformation [[Kangxi: 敎也, 風是諸侯政敎也]];
    - institutes, influence;
    - disposition, temper;
    - to affect by example;
    - heat in animals [[Kangxi: 佚也, ::[...]風放也牝牡相誘謂之風[...]::]];
    - _t(a/)i(6) (1)fung_
        [[daai6 fung1 大風]],
        a gale, a tyfoon;
    - _(1)fung (5)m(a/)ng_
    ...
    - _shun(6) (1)fung_
        [[seon6 fung1 順風]],
        a fair wind;
    - _(2)sh(i/)m (1)sh(a/)n (1)fung_
        [[sim2 saan1 fung1 閃山風]],
        a gust;
    - _ng(a/)k(9) (1)fung_
        [[ngaak6 fung1 額風]],
        a head wind;
    - _(4)w(a/)ng (1)fung_
        [[waang4 fung1 橫風]],
        a side wind;
    - _(1)fung (1)sheng_ [[fung1 seng1 風聲]],
        or
      _(4)lau (1)fung_ [[lau4 fung1 流風]],
        a rumor;
    - _(1)fung tsuk(9)_
        [[fung1 zuk6 風俗]]
        usage;
    ...
    - _(1)fung (1)s(e/)ung_
        [[fung1 soeng1 風箱]],
        a bellows;
    - _(2)kwai (4)t(')au (1)fung_
        [[gwai2 tau4 fung1 鬼頭風]],
        an adverse wind;
    - _(4)man (1)fung chuk(7) (2)ying_
        [[man4 fung1 zuk1 jing2 聞風捉影]],
        a newsmonger, an idle talebearer;
    - _(1)k(o\)m p(a/)i(3) ~~h(a/)(3)~~ ``h(a/)(6)`` (1)fung_
        [[gam1 baai3 haa6 fung1 甘拜下風]],
        I willingly acknowledge your superiority;
    - _(1)fung (4)ts(')ing_
        [[fung1 cing4 風情]]^
        lascivious looks.
    ==
...
C
  ==
  - Williams' 大風: In modern usage, it is 颱風 that is a typhoon.
  - Williams' 甘拜下風: Corrected _h(a/)(3)_ (haa3) to _h(a/)(6)_ (haa6).
  ==
P
  ++
  1. News.
  1. Scenery.
      ==
      - 放風 (fong3 fung1): "Release [the] news."
      - 收到風 (sau1 dou3-2 fung1): "Received news."
      ==
  1. "Wind" in Chinese medicine.
      ==
