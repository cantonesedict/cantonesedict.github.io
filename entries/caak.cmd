...
WP
  ==
  - Ch(')(a/)k <span class="modern">= *[tɕʰaːk̚]</span>
  - Ts(')(a/)k <span class="modern">= *[tsʰaːk̚]</span>
  ==
MP
  ==
...
P
  ++
  1. Reading variation. **See $惻cak1 for the canonical entry.**
  ++
S
  ==
  - $惻cak1
...
P
  ++
  1. Reading variation. **See $測cak1 for the canonical entry.**
  ++
S
  ==
  - $測cak1
...
E
  ...
  --
  """"
  ::K. (:坼:) 《唐韻》(:丑格切:)《集韻》《韻會》《正韻》(:恥格切:){𠀤=⿱夶一}同{𤖴=⿰片斥}(:裂也:)\
  《禮月令》仲冬地始坼\
  《後漢安帝紀》日南地坼長百餘里\
  《晉史天文志》惠帝中張華爲司空三台星坼[...]::
  """"
