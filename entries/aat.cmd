...
P
  ++
  1. Reading variation. **See $戛gaat3 for the canonical entry.** (TODO)
  ++
S
  ==
  - $戛gaat3 (TODO)
...
C
  ...
  - Williams has the non-pawn senses under _(A/)p(8)_ (aap3)
    ...
    Whilst _(a/)p(8)_ (aap3) is expected from Middle Chinese 烏甲切,
    the common reading of 押 is _(a/)t(8)_ (aat3).
...
W
  ...
  - [[Page~5 秸(8)]]
    --
    [[Reading variation. **See $秸gaai1 for the canonical entry.**]] [[TODO]]
    --
  ====
S
  ==
