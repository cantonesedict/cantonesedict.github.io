...
WP
  ==
  - Ch(a/) <span class="modern">= [tɕaː]</span>
  - Ts(a/) <span class="modern">= [tsaː]</span>
  ==
MP
  ==
  - zaa = [tsaː] ((preferred)), [tɕaː]
  ==
$$
...
C
  ...
  - Williams' 蚱蟬: Changed Middle Chinese _(4)sh(i/)n_ (sin4)
