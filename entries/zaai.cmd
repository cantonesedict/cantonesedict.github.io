...
W
  ...
  - [[Page~10|n53 ::(1)齋(1)[斋]^::]]
    ...
    - _(2)t(a/) (1)ch(a/)i hok(9)_
        [[daa2 zaai1 hok6-2 打齋鶴]]
        storks for the soul to ride to heaven;
        _met._ a pander;
    - _t(a/)i(6) sz'(6) (1)ch(a/)i_
        [[daai6 si6 zaai1 大士齋]],
        offerings before the purveyor of hungry spirits;
    - _(4)h(a/)n (1)ch(a/)i_
        [[haan4 zaai1 閒齋]],
        a closet;
    - _(1)sh(u") (1)ch(a/)i_
    ...
    --
    ==
    - A final particle denoting that it was said, that it is so;
...
E
  ...
  - 【齋】 (zaai1):
    ...
    1. Vegetarian food.
       ==
       - 初一十五食齋 (co1 jat1 sap6 ng5 sik6 zaai1):
         "Eating vegetarian [on the] first [and] fifteenth [of the lunar month]."
       - 齋口唔齋心 (zaai1 hau2 m4 zaai1 sam1):
         "Vegetarian [in] mouth [but] not vegetarian [at] heart"
         (said of vegetarians that eat imitation meat).
       ==
    1. Plain, pure, etc.
       ==
