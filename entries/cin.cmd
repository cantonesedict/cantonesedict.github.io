...
WP
  ==
  - Ch(')(i/)n <span class="modern">= *[tɕʰiːn]</span>
  - Ts(')(i/)n <span class="modern">= *[tsʰiːn]</span>
  ==
MP
  ==
...
W
  ...
  - [[Page~574 (1)躚]]
    --
    [[Reading variation. **See $躚sin1 for the canonical entry.**]] [[TODO]]
    --
  ====
S
  ==
...
W
  ...
  - [[Page~17* (4)纏]]
    ...
    - to bother;
    - _(4)ch(')(i/)n k(e/)uk(8)_
        [[cin4 goek3 纏腳]]
        to bandage the feet;
    - _(4)ch(')(i/)n (4)t(')au_
        [[cin4 tau4 纏頭]],
        to bind the head with a turban;
    - _(4)ch(')(i/)n (2)shau_
        [[cin4 sau2 纏手]],
        to prevent doing;
    - _(4)ch(')(i/)n (2)kan_
...
C
  ==
  - Fan Wan entry: Normalised headword (with 厂 and 黑-like interior) to 纏.
...
W
  ...
  - [[Page~18* (4)躔]]
    ==
    - To tread [[Kangxi: 踐也]];
    - to follow in order [[Kangxi: 星之躔次星所履行也]];
    - to turn in an orbit [[Kangxi: 歷行也日運爲躔]];
    - a trodden path [[Kangxi: 躔徑也]], a rut [[Kangxi: 行徑轍迹也]], a footstep [[Kangxi: 脚所踐處]];
    - a course, an orbit;
    - _tsik(7) (4)ch(')(i/)n_
        [[zik1 cin4 跡躔]],
