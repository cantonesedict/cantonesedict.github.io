...
WP
  ==
  - Ch(')(u:)n <span class="modern">= *[tɕʰyːn]</span>
  - Ts(')(u:)n <span class="modern">= *[tsʰyːn]</span>
  ==
MP
  ==
  - cyun = [tsʰyːn], [tɕʰyːn] ((preferred))
  ==
$$
...
P
  ...
  1. The 47th~radical (U+2F2E ⼮ "river").
  ++
$$
...
F
  ==
  - (F2.19 川) 山川衆流也又川穿也謂穿地而流也
  ==
W
  ====
  - [[Page~38* (1)川]]
    ==
    - ~~Mountain~~ streams, ~~perennial~~ brooks [[Kangxi: 穿也穿地而流也]];
...
C
  ==
  - Williams' 川崖: Corrected _(4)ngai_ (ngai4) to _(4)ng(a/)i_ (ngaai4).
  ==
P
  ++
  1. Short for 四川.
...
W
  ...
  - [[Page~38* (2)舛]]
    ...
    - to contradict;
    - the 136th~radical [[U+2F87 ⾇ "oppose"]]``;``
...
E
  ...
  - 【串】 (cyun3)
    ...
    1. To spell (of words in an alphabetic language).
       ...
       ==
    1. Arrogant, cocky. The spelling 串 for this word is arbitrary.
    ++
  ====
S
  ==
