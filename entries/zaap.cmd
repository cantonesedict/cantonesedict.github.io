...
MP
  ==
  - zaap = [tsaːp̚] ((preferred)), [tɕaːp̚]
  ==
$$


##{#3 .williams} Ch(a/)p(8) [[zaap3 低陰入]]
...
W
  ...
  - [[Page~22|n65 劄(8)]]
    ...
    - _ch(a/)p(8) k(a/)(3) (4)ts(')(i/)n_
        [[zaap3 gaa3 cin4 劄價錢]],
        write the prices;
    - _ch(a/)p(8) lok(9) p(o\)(6)_
        [[zaap3 lok6 bou6-2 劄落簿]]
        put it to account;
    - _ch(a/)p(8) (1)t(a/)n_
        [[zaap3 daan1 劄單]],
    ...
    ==
    --
    The word _chop_, used in Canton is derived from this.
    --
  ====
C
  ==
...
W
  ...
  - [[Page~22|n65 閘(9)]]
    ...
    - _(1)kw(a/)n ch(a/)p(9)_
        [[gwaan1 zaap6 關閘]]
        to shut the gate;
        the Barrier at Macao;
    - _(2)shui ch(a/)p(9)_
        [[seoi2 zaap6 水閘]]
