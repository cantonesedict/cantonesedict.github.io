...
P
  ...
  1. (_astrology_) Conflicting, incompatible.
  ++
L
  ====
  * 【沖】 (drjuwng)
...
W
  ...
  - [[Page~608 (1)聰(1)聦]]
    --
    [[Alternative form of 聰. **See $聰cung1 for the canonical entry.**]]
    --
  ====
C
  ==
...
P
  ++
  1. Alternative form of 叢. **See $叢cung4 for the canonical entry.**
  ++
$$
...
W
  ====
  - [[Page~40* 重(6) _Chung(6)_ (zung6); here corrected to _(5)Ch(')ung_ (cung5)]]
    ==
    - Heavy, weighty [[Kangxi: 毛氏曰凡物不輕而重則上聲]];
    - [[...]];
    - severe, heinous;
    - [[...]];
...
C
  ...
  - I have split things up accordingly, noting that the
    ...
    (and, in particular, is rising in 重病, 重刑, etc.).
