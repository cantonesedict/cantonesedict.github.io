...
W
  ...
  - [[Page~588 (1)哉]]
    ...
    - _(1)on pat(7) (1)p(i/) (1)tsoi_
        [[on1 bat1 bei1 zoi1 安不悲哉]],
        how could I forbear pity?
    - _sik(7) (1)tsoi_
        [[sik1 zoi1 惜哉]],
        sad indeed!
    - _t(a/)i(6) (1)tsoi man(6)_
        [[daai6 zoi1 man6 大哉問]]
        ah! truly an important question;
    - _t(a/)i(6) (1)tsoi (2)Hung (2)tsz'_
        [[daai6 zoi1 hung2 zi2 大哉孔子]]
        Confucius, oh, how great!
...
C
  ==
  - The alternative form U+39B2 㦲 (⿹𢦏勹)
    is known to appear incorrectly in at least one sans-serif font;
    check the [Font test page](/font-test/#u39b2).
...
W
  ...
  - [[Page~588 (1)災(1)灾(1)烖]]
    ...
    - _(1)chi(u/) (1)tsoi_
        [[ziu1 zoi1 招災]],
        to bring evil on one's self;
    - _(1)t(')(i/)n (1)tsoi (4)w(a/)ng wo(6)_
        [[tin1 zoi1 waang4 wo6 天災橫禍]]
        divine and unforeseen judgments;
    ...
    - _(2)shui (1)tsoi_
        [[seoi2 zoi1 水災]],
        a flood;
    - _(1)t(')(i/)n (1)tsoi (4)lau (4)hang_
        [[tin1 zoi1 lau4 hang4 天災流行]],
        an epidemic;
    - _(1)tsoi (1)y(e/)ung kok(8) t(i/)(6) (4)t(')au_
        [[zoi1 joeng1 gok3 dei6 tau4 災殃各地頭]],
        each place has its own calamity.
    ==
  ====
C
  ==
