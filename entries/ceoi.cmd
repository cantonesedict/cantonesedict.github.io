...
WP
  ...
  - Ch(')ui <span class="modern">= [tɕʰʊi]</span>
  - Ts(')(u:) <span class="modern">= [tsʰyː]</span>
  - Ts(')ui <span class="modern">= [tsʰʊi]</span>
  - Ts(')(u/)i <span class="modern">= [tsʰuːɪ]</span>
  ==
MP
  ==
  - ceoi = [tsʰɵy], [tɕʰɵy] ((preferred))
  ==
S
  ==
  - $cyu
...
W
  ====
  - [[Page~597 (4)隨; here normalised to {𡃴=⿰口隨}]]
    --
    [[...]]
    --
    --
...
W
  ...
  - [[Page~34* (4)槌(4)椎]]
    --
    [[Alternative form of 槌. **See $槌ceoi4 for the canonical entry.**]]
    --
  ====
S
  ==
...
E
  ...
  - 【除】 (ceoi4):
    ...
    1. To remove clothing, accessories, footwear, etc.
       ==
       - 除衫 (ceoi4 saam1): "Take off clothes."
       - 除褲 (ceoi4 fu3): "Take off pants."
       - 除帽 (ceoi4 mou6-2): "Take off [a] hat."
       - 除鞋 (ceoi4 haai4): "Take off shoes."
       ==
    ++
  ====
S
