...
W
  ...
  - [[Page~26|n69 (1)抽]]
    ...
    - _(1)ch(')au (1)shau_
        [[cau1 sau1 抽收]],
        to levy duty on;
    - _(1)ch(')au (1)shan pat(7) h(a/)(6)_
        [[cau1 san1 bat1 haa6 抽身不暇]]
        no leisure at all;
    - _(1)ch(')au shat(9)_
        [[cau1 sat6 抽實]]
        lift it up firmly;
    ...
    - _(1)ch(')au (4)ch(')au_ [[cau1 cau4 抽籌]],
        or
      _(1)ch(')au (4)t(')au_ [[cau1 tau4 抽頭]],
        to divide winnings;
    - _(1)ch(')au (4)h(a/)n_
        [[cau1 haan4 抽閒]],
        to take a leisure hour;
    - _(1)ch(')au (1)fan_
        [[cau1 fan1 抽分]],
        to take a commission, to reserve a part;
    - _(1)k(a/) yat(7) (1)ch(')au_
        [[gaa1 jat1 cau1 加一抽]],
        take a tenth.
    ==
  ====
...
W
  ...
  - [[Page~562 (1)揫(1)揪]]
    --
    [[Reading variation. **See $揪zau1 for the canonical entry.**]]
    --
  ====
S
  ==
...
W
  ...
  - [[Page~562 (1)湫]]
    ...
    ==
    --
    [[Otherwise, a reading variation. **See $湫zau1 for the canonical entry.**]]
    --
  ====
C
  ==
...
C
  ====
  - Williams does not record the form 讎,
...
W
  ...
  - [[Page~27|n70 (4)酬(4)酧]]
    --
    [[Alternative form of 酬. **See $酬cau4 for the canonical entry.**]]
    --
  ====
$$
