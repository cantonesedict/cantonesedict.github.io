...
WP
  ==
  - Ch(')o <span class="modern">= *[tɕʰɔː]</span>
  - Ts(')o <span class="modern">= *[tsʰɔː]</span>
  ==
MP
  ==
  - co = [tsʰɔː], [tɕʰɔː] ((preferred))
  ==
$$
...
W
  ...
  - [[Page~26* (1)初]]
    ...
    - _(1)ch(')o (4)ts(')un_
        [[co1 ceon4 初旬]],
        the first decade;
    - _(1)ch(')o (1)hoi fau(6)_
        [[co1 hoi1 fau6 初開埠]]
        to found a mart;
    - _(1)ch(')o (2)k(i/)_
        [[co1 gei2 初幾]],
        which day of the first decade is it?
    ==
  ====
C
  ==
...
W
  ...
  - [[Page~583 (1)瘥]]
    --
    [[Reading variation. **See $瘥co4 for the canonical entry.**]]
    --
  ====
S
  ==
...
P
  ++
  1. Reading variation (verb-like). See $坐zo6.
  ++
S
  ==
  - $坐zo6
