...
WP
  ==
  - Ch(')i(u/) <span class="modern">= *[tɕʰiːu]</span>
  - Ts(')i(u/) <span class="modern">= *[tsʰiːu]</span>
  ==
MP
  ==
...
W
  ...
  - [[Page~25* (1)昭]]
    ...
    - _(1)ch(')i(u/) muk(9)_
        [[ciu1 muk6 昭穆]]
        the order of precedence in the ancestral hall;
    - _(5)(i/) muk(9) (1)ch(')i(u/) (1)ch(e/)ung_
        [[ji5 muk6 ciu1 zoeng1 耳目昭彰]],
        bright to the eyes and clear to the ears, as a reputation;
    - _(1)ch(')i(u/) (4)(i/)n_
        [[ciu1 jin4 昭然]],
        intelligible;
