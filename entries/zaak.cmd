...
E
  ...
  """"
  """"
  ::K. (:磓:) 《廣韻》《集韻》《韻會》《正韻》{𠀤=⿱夶一}都回切音堆(:聚石也又以石投下也:)亦作塠[...]::
  """"
S
  ==
  - ($矺zaak6)
...
P
  ++
  1. Reading variation. **See $蚱zaa3 for the canonical entry.**
  ++
S
  ==
  - $蚱zaa3
...
W
  ...
  - [[Page~13|n56 {𧓸=⿰虫鄭}(9)]]
    ...
    - A large green caterpillar,
      ...
      which feeds on bean leaves [[Kangxi: {𧓸=⿰虫鄭}蠋蟲名]].
    ==
  ====
$$
...
P
  ++
  1. Alternative form of 躑. **See $躑zaak6 for the canonical entry.**
  ++
S
  ==
  - $蹢dik1 (TODO)
