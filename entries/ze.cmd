...
WP
  ==
  - Ch(e/) <span class="modern">= *[tɕeɪ]</span>
  - Ts(e/) <span class="modern">= *[tseɪ]</span>
  ==
MP
  ==
...
C
  ...
  - Williams' 中也者天下之大本也: Changed _(5)h(a/)_ (haa5) to modern _h(a/)(6)_ (haa6).
    This example should appear under the "puts them in apposition" sense.
...
W
  ...
  - [[Page~31|n74 這(3)]]
    --
    [[Reading variation. **See $這ze2 for the canonical entry.**]]
    --
  ====
S
  ==
