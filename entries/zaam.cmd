...
WP
  ==
  - Ch(a/)m <span class="modern">= *[tɕaːm]</span>
  - Ts(a/)m <span class="modern">= *[tsaːm]</span>
  ==
MP
  ==
  - zaam = [tsaːm] ((preferred)), [tɕaːm]
  ==
$$
...
W
  ...
  - [[Page~15|n58 (2)斬]]
    ...
    - _(1)i(u/) (2)ch(a/)m_
        [[jiu1 zaam2 腰斬]],
        to divide a criminal in the middle;
    - _(2)ch(a/)m (1)teng ts(i/)t(9) t(')(i/)t(8)_
        [[zaam2 deng1 zit6 tit3 斬釘截鐵]]
        to cut an iron nail---decided, sincere;
    - _(1)k(a/)m (2)ch(a/)m_
        [[gaam1 zaam2 監斬]],
        to superintend an execution;
    - _(2)ch(a/)m (1)hoi_
        [[zaam2 hoi1 斬開]],
        to cut open;
...
E
  ...
  ====
  --
  The spelling 䁪 is arbitrary.
  The alternative spelling 眨 is from appropriation of formal 眨 _ch(a/)p(8)_ (zaap3).
  --
$$
